  ...
  return (
    <div className="bg-light dark:bg-[#27282c] border border-gray-300 dark:border-none p-6 rounded-lg shadow-lg dark:shadow-lg">
      <img
        ...
        alt="Project 1"
      />
      <h4 className="text-xl font-bold text-dark dark:text-light pt-2">
        {title}
      </h4>
      <p className="mt-2 text-dark dark:text-light py-2">{description}</p>
      {tags && tags.length && (
      ...
      <div className="mt-8 flex space-x-4">
        <a
          href={githubLink}
          target="_blank"
          className="text-dark hover:text-primary dark:text-light dark:hover:text-gray-400 transition duration-300"
        >
